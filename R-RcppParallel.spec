...
Version  : 5.1.10
Release  : 51
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/RcppParallel_5.1.10.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/RcppParallel_5.1.10.tar.gz
...
%package dev
Summary: dev components for the R-RcppParallel package.
Group: Development
Requires: R-RcppParallel-lib = %{version}-%{release}
Provides: R-RcppParallel-devel = %{version}-%{release}
Requires: R-RcppParallel = %{version}-%{release}

%description dev
dev components for the R-RcppParallel package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737731940
